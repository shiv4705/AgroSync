                  ...
                  <h1 className="font-serif text-4xl font-bold tracking-tighter text-green-900 dark:text-teal-50 dark:text-enhance sm:text-5xl md:text-6xl">
                    ...
                    >
                      ...
                      <span className="relative inline-block">
                        <span className="relative z-10 text-green-600 dark:text-teal-400">
                          Nature
                        </span>
                    ...
                    >
                      ...
                      <span className="relative inline-block">
                        ...
                        <span className="absolute -bottom-1 left-0 z-0 h-3 w-full bg-blue-100 dark:bg-blue-900/50"></span>
                      </span>
                    </motion.span>
                  </h1>
                </motion.div>
